...
window.init = function(){
   ...
   // material2.diffuseColor = [1,0,0,1];
	...
	window.rtCamera.position[0] = parseInt(this.value);
	window.rtCamera.lookAt[0] = parseInt(this.value);
    });

    var dirXSlider = createSlider("Pos Z : ", 0, -7, 7, function(){
        window.adam.localPosition[2] = parseInt(this.value) + 8;
	window.rtCamera.position[2] = parseInt(this.value) - 10;
	window.rtCamera.lookAt[2] = parseInt(this.value) + 1;
    });
